		...
		<div class="workplace form-horizontal admin-content-bg-white">
			...
			<div id="divPosition" visible="false" runat="server" class="settingrow form-group row align-items-center">
				<gb:SiteLabel ID="lblPosition" runat="server" ForControl="chkListPosition"
					CssClass="settinglabel control-label col-sm-3 mb-0" ConfigKey="BannerPositionLabel"
			...
			<asp:UpdatePanel ID="up" runat="server">
				<ContentTemplate>
					...
					<div class="settingrow form-group row align-items-center">
						<gb:SiteLabel ID="lblQuestion" runat="server" ForControl="edQuestion"
							CssClass="settinglabel control-label col-sm-3 mb-0" ConfigKey="QuestionLabel"
							ResourceFile="FAQsResources" />
						<div class="col-sm-9">
							<gbe:EditorControl ID="edQuestion" runat="server" />
							<asp:TextBox ID="txtQuestion" Visible="false" runat="server" />
						</div>
					</div>
					<div class="settingrow form-group row align-items-center mb-0">
						<gb:SiteLabel ID="lblAnswer" runat="server" ForControl="edAnswer"
							CssClass="settinglabel control-label col-sm-3 mb-0" ConfigKey="AnswerLabel"
							ResourceFile="FAQsResources" />
						<div class="col-sm-9">
