				...
				<div class="headInfo form-horizontal admin-content-bg-white">
					<portal:HeadingPanel ID="heading" runat="server">
						...
						<asp:HyperLink SkinID="InsertButton" ID="lnkInsert"
							Text="<%$Resources:FAQsResources, InsertLink %>" runat="server" />
						<asp:Button SkinID="DeleteButton" ID="btnDelete"
							Text="<%$Resources:FAQsResources, DeleteSelectedButton %>" runat="server"
			...
			<div class="col-12">
				<div class="workplace admin-content-bg-white">
					<telerik:RadGrid ID="grid" SkinID="radGridSkin" runat="server">
						<MasterTableView DataKeyNames="ItemID,DisplayOrder,Position" AllowSorting="false"
							...
							<Columns>
								...
								<telerik:GridTemplateColumn HeaderText="<%$Resources:FAQsResources, PositionLabel %>"
								...
								<telerik:GridTemplateColumn HeaderStyle-Width="100"
									HeaderText="<%$Resources:FAQsResources, DisplayOrderLabel %>"
									AllowFiltering="false">
									<ItemTemplate>
								...
								<telerik:GridTemplateColumn HeaderStyle-Width="100" AllowFiltering="false">
									<ItemTemplate>
										<asp:HyperLink CssClass="cp-link" ID="EditLink" runat="server"
											Text="<%# Resources.FAQsResources.EditLink %>"
