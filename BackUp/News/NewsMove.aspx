								...
								<div class="box-header">
									<div class="form-horizontal">
										<div class="settingrow form-group row align-items-center mb-0">
											...
											<div class="col-sm-9">
												<asp:DropDownList ID="ddZones1" Width="100%" AutoPostBack="true"
									...
									<telerik:RadGrid ID="grid1" SkinID="radGridSkin" runat="server">
										<MasterTableView DataKeyNames="NewsID,ZoneID">
											<Columns>
												...
												<telerik:GridTemplateColumn
													HeaderText="<%$Resources:NewsResources, NewsEditTitleLabel %>"
									...
									<div class="form-horizontal">
										<div class="settingrow form-group row align-items-center mb-0">
											<gb:SiteLabel ID="lblZones2" runat="server" ConfigKey="ZoneLabel"
												...
												CssClass="settinglabel control-label col-sm-3 mb-0" />
											<div class="col-sm-9">
												<asp:DropDownList ID="ddZones2" Width="100%" AutoPostBack="true"
													runat="server" CssClass="form-control" />
											</div>
										</div>
									</div>
