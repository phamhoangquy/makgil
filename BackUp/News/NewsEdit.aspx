...
<asp:Content ContentPlaceHolderID="mainContent" ID="MPContent" runat="server">
    ...
    <div class="admin-content">
        <asp:Panel ID="pnlNews" runat="server" CssClass="workplace admin-content-bg-white" DefaultButton="btnUpdate">
            <div id="divtabs" class="tabs">
                <ul class="nav nav-pills margin-bottom" role="tablist">
                    <li role="presentation" class="nav-item">
						<a href="#tabContent" aria-controls="tabContent" role="tab" data-toggle="tab" class="nav-link active">
						<asp:Literal ID="litContentTab" runat="server" /></a>
					</li>
                    <li id="liImages" class="nav-item newsedit-imagetab" runat="server">
                        <asp:Literal ID="litImagesTab" runat="server" /></li>
                    <li id="liAttribute" class="nav-item newsedit-attributetab" runat="server">
                        <asp:Literal ID="litAttributeTab" runat="server" /></li>
                    <li class="nav-item newsedit-metatab"><a href="#tabMeta" aria-controls="tabMeta" role="tab" data-toggle="tab" class="nav-link">
                        <asp:Literal ID="litMetaTab" runat="server" /></a></li>
                </ul>
                <div class="tab-content">
                    <div id="tabContent" role="tabpanel" class="tab-pane fade active show in">
                    <div class="form-horizontal">
                        <div class="settingrow form-group row align-items-center">
                            ...
                            <div class="col-sm-9">
                                <div class="input-group">
                                    <asp:DropDownList ID="ddZones" runat="server" class="form-control"/>
                        ...
                        <asp:UpdatePanel ID="up" runat="server">
                            <ContentTemplate>
                                ...
                                <div class="settingrow form-group row align-items-center">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group">
                                            <asp:TextBox ID="txtTitle" runat="server" MaxLength="255" CssClass="forminput verywidetextbox form-control" />
                                ...
                                <div id="divSubTitle" runat="server" class="settingrow form-group row align-items-center newsedit-subtitle">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group">
                                            <asp:TextBox ID="txtSubTitle" runat="server" MaxLength="255" CssClass="forminput verywidetextbox form-control" />
                                            <portal:gbHelpLink ID="GbHelpLink2" runat="server" HelpKey="newsedit-subtitle-help" />
                                        </div>
                                    </div>
                                </div>
                                <div class="settingrow form-group row align-items-center newsedit-url">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group">
                                            <asp:TextBox ID="txtUrl" runat="server" MaxLength="255" CssClass="forminput verywidetextbox form-control" />
                                ...
                                <div class="settingrow form-group row align-items-center newsedit-excerpt">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group">
                                            <gbe:EditorControl ID="edBriefContent" runat="server" class="form-control p-0"/>
                                            <portal:gbHelpLink ID="GbHelpLink4" runat="server" HelpKey="newsedit-briefcontent-help" />
                                        </div>
                                    </div>
                                </div>
                                <div class="settingrow form-group row align-items-center newsedit-content">
                                    <gb:SiteLabel ID="lblFullContent" runat="server" CssClass="settinglabel control-label col-sm-3" ConfigKey="Content"
                                        ResourceFile="NewsResources" />
                                    <div class="col-sm-9">
                                        <div class="input-group">
                                            <gbe:EditorControl ID="edFullContent" runat="server" class="form-control p-0"/>
                        ...
                        <div class="settingrow form-group row align-items-center" runat="server" id="divUploadImage">
                        ...
                        <div id="divFileAttachment" runat="server" class="settingrow form-group row align-items-center newsedit-attachfile">
                            ...
                            <div class="col-sm-9">
                                <div class="input-group">
                                    <asp:TextBox ID="txtFileAttachment" MaxLength="255" runat="server" class="form-control"/>
                        ...
                        <div id="divPosition" visible="false" runat="server" class="settingrow form-group row align-items-center">
                        ...
                        <div id="divShowOption" visible="false" runat="server" class="settingrow form-group row align-items-center">
							...
							<div class="col offset-sm-3">
									<div class="settingrow form-group newsedit-newwindow">
											...
											<gb:SiteLabel ID="lblOpenInNewWindow" runat="server" ForControl="chkOpenInNewWindow" ConfigKey="OpenInNewWindowLabel"
												ResourceFile="NewsResources" CssClass="settinglabel control-label" />
											<div class="">
											</div>
										</div>
                        ...
                        <div id="divStartDate" runat="server" class="settingrow form-group row align-items-center newsedit-published newsedit-startdate">
                        ...
                        <div id="divEndDate" runat="server" class="settingrow form-group row align-items-center newsedit-published newsedit-enddate">
                        ...
                        <div id="divCommentAllowedForDays" class="settingrow form-group row align-items-center" runat="server" visible="false">
                                ...
                                <div class="form-horizontal">
									...
									<div class="settingrow form-group row align-items-center">
										<div class="offset-sm-3 col">
											...
											<asp:Button SkinID="DeleteButton" ID="btnDeleteImage" Visible="false" OnClick="btnDeleteImage_Click"
                                    ...
                                    <div class="col-md-3">
                                        <div class="input-group">
                                            <asp:ListBox ID="lbAttribute" Width="100%" Height="500" AutoPostBack="true" runat="server"
                                                AppendDataBoundItems="true" DataTextField="Title" DataValueField="Guid" Cssclass="p-15"/>
                                            <div class="input-group-addon">
                                                <ul class="nav sorter">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <div class="form-horizontal">
                                            <div class="settingrow form-group row align-items-center">
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="input-group">
                                                        <asp:TextBox ID="txtAttributeTitle" runat="server" MaxLength="255" Cssclass="form-control"/>
                                            ...
                                            <div class="settingrow form-group row align-items-center">
                                                <div class="col offset-sm-3 ">
                                                    ...
                                                    <asp:Button SkinID="DeteleButton" ID="btnDeleteAttributeLanguage" Visible="false" OnClick="btnDeleteAttributeLanguage_Click" Text="<%$Resources:Resource, DeleteLanguageButton %>" runat="server" CausesValidation="false" />
                                                </div>
                                            </div>
                                            <div class="settingrow form-group row align-items-center">
                                                <gb:SiteLabel ID="lblAttributeContent" runat="server" CssClass="settinglabel control-label col-sm-3" ConfigKey="AttributeContent"
                                                    ResourceFile="NewsResources" />
                                                <div class="col-sm-9">
                            ...
                            <asp:UpdatePanel ID="upSEO" runat="server">
                                <ContentTemplate>
                                    ...
                                    <div class="settingrow form-group row align-items-center">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group">
                                                <asp:TextBox ID="txtAdditionalMetaTags" TextMode="MultiLine" runat="server" CssClass="form-control"/>
        ...
        <asp:Panel ID="pnlWorkflow" CssClass="workplace form-horizontal" runat="server" Visible="false">
            ...
            <div id="divRecentActionBy" visible="false" runat="server" class="settingrow form-group row align-items-center">
            ...
            <div id="divRecentActionOn" visible="false" runat="server" class="settingrow form-group row align-items-center">
            ...
            <div id="divRejection" visible="false" runat="server" class="settingrow form-group row align-items-center">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="form-horizontal">
                ...
                <div id="divCopyNewsPublished" runat="server" class="settingrow form-group row align-items-center">
