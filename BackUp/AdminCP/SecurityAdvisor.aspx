...
<asp:Content ContentPlaceHolderID="mainContent" ID="MPContent" runat="server">
	<portal:BreadcrumbAdmin ID="breadcrumb" runat="server" CurrentPageTitle="<%$Resources:Resource, SecurityAdvisor %>"
		CurrentPageUrl="~/AdminCP/SecurityAdvisor.aspx" />
		...
		<div class="workplace admin-content-bg-white">
			...
			<ul class="simplelist">
				<li>
					...
					<p>
						<asp:TextBox ID="txtRandomMachineKey" runat="server" TextMode="MultiLine" Rows="5" Columns="70"
							Width="100%" Cssclass='form-control mb-20 mt-20' />
						<asp:HyperLink CssClass="cp-link btn btn-default" ID="lnkMachineKeyRefresh" runat="server"
							Visible="false" />
					</p>
					<p>
						<gb:SiteLabel ID="lblMachineKeyInstructions" runat="server" CssClass=""
							ConfigKey="CustomMachineKeyInstructions" UseLabelTag="false" Visible="false" />
					</p>
				</li>
				<li>
