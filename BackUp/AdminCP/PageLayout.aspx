...
<asp:Content ContentPlaceHolderID="mainContent" ID="MPContent" runat="server">
    ...
    <div class="admin-content">
        ...
        <asp:Panel ID="pnlContent" CssClass="pagelayout workplace admin-content-bg-white" runat="server" Visible="False">
			<div class="mb-20">
				<portal:HeadingPanel ID="heading" runat="server" Cssclass="">
                ...
                <ContentTemplate>
                    <div class="row">
                        <div id="divAddContent" runat="server" class="col-sm-5">
                            ...
                            <div class="form-horizontal">
                                <div class="settingrow form-group">
                                    <gb:SiteLabel ID="lblModuleType" runat="server" ForControl="moduleType" CssClass="settinglabel control-label"
                                        ConfigKey="PageLayoutModuleTypeLabel" />
                                    <div class="">
                                        <div class="input-group">
                                            <asp:DropDownList ID="moduleType" runat="server" EnableTheming="false" CssClass="forminput form-control"
                                ...
                                <div class="settingrow form-group">
                                    <gb:SiteLabel ID="lblModuleName" runat="server" ForControl="moduleTitle" CssClass="settinglabel control-label"
                                        ConfigKey="PageLayoutModuleNameLabel" />
                                    <div class="">
                                        <div class="input-group">
                                            <asp:TextBox ID="moduleTitle" runat="server" CssClass="widetextbox forminput form-control" Text=""
                                ...
                                <div class="settingrow form-group">
                                    <gb:SiteLabel ID="SiteLabel2" runat="server" ForControl="ddPaneNames" CssClass="settinglabel control-label"
                                        ConfigKey="PageLayoutLocationLabel" />
                                    <div class="">
                                        <div class="input-group">
                                            <asp:DropDownList ID="ddPaneNames" runat="server" EnableTheming="false" CssClass="forminput form-control"
                                                DataTextField="key" DataValueField="value">
                                            </asp:DropDownList>
                                            <portal:gbHelpLink ID="gbHelpLink3" runat="server" HelpKey="pagelayoutmodulelocationhelp" />
                                        </div>
                                        <asp:HyperLink ID="lnkGlobalContent" CssClass="cp-link btn btn-default mt-20" runat="server" Visible="false" />
                                        <asp:HiddenField ID="hdnModuleID" runat="server" />
                                        <asp:ImageButton ID="btnAddExisting" runat="server" />
                                    </div>
                                </div>
                                <div class="settingrow form-group">
                                    <gb:SiteLabel ID="lblOrganizeModules" runat="server" CssClass="settinglabel control-label d-none" ConfigKey="EmptyLabel"
                                        UseLabelTag="false" />
                                    <div class="">
                        ...
                        <div class="col-sm-7">
                            ...
                            <div class="form-horizontal">
                                <div class="settingrow form-group">
                                    <gb:SiteLabel ID="lblPage" runat="server" ForControl="ddlPages" CssClass="settinglabel control-label"
                                        ConfigKey="PageLayoutCopyPageLabel" />
                                    <div class="">
                                        <div class="input-group">
                                            <asp:DropDownList ID="ddlPages" runat="server" DataTextField="PageName" DataValueField="PageID"
                                                AutoPostBack="true" CssClass="forminput form-control" />
                                ...
                                <div id="divAddExistContent" runat="server" visible="false">
                                    <div class="settingrow form-group">
                                        <gb:SiteLabel ID="SiteLabel3" runat="server" ForControl="ddlPageModules" CssClass="settinglabel control-label"
                                            ConfigKey="PageLayoutModuleTypeLabel" />
                                        <div class="">
                                            <asp:DropDownList ID="ddlPageModules" AutoPostBack="true" runat="server" EnableTheming="false"
                                                CssClass="forminput form-control" DataTextField="ModuleTitle" DataValueField="ModuleID">
                                            </asp:DropDownList>
                                            <asp:Literal ID="litFeatureName" runat="server" />
                                        </div>
                                    </div>
                                    <div class="settingrow form-group">
                                        <gb:SiteLabel ID="SiteLabel5" runat="server" ForControl="txtModuleTitle" CssClass="settinglabel control-label"
                                            ConfigKey="PageLayoutModuleNameLabel" />
                                        <div class="">
                                            <div class="input-group">
                                                <asp:TextBox ID="txtModuleTitle" runat="server" CssClass="widetextbox forminput form-control"
                                    ...
                                    <div class="settingrow form-group">
                                        <gb:SiteLabel ID="SiteLabel4" runat="server" CssClass="settinglabel control-label" ConfigKey="EmptyLabel"
                                            UseLabelTag="false" />
                                        <div class="">
                                    ...
                                    <div class="settingrow form-group">
                                        <gb:SiteLabel ID="SiteLabel6" runat="server" CssClass="settinglabel control-label" ConfigKey="EmptyLabel"
                                            UseLabelTag="false" />
                                        <div class="">
                    ...
                    <div class="panelayout">
                        <div visible="false" runat="server" class="altlayoutnotice mb-20">
                            <asp:Literal ID="litEditNotes" runat="server" />
                        </div>
                        <asp:Panel class="altlayoutnotice mb-20" ID="divAltLayoutNotice" runat="server" SkinID="notice">
                                            ...
                                            <ul class="nav sorter">
                                                ...
                                                <li>
                                                    <asp:LinkButton ID="btnDeleteAlt1" runat="server" CommandName="delete" CommandArgument="lbAltContent1"
                                                        SkinID="pageLayoutDeleteItem" CssClass="btnremove"><i class="fa fa-trash-alt"></i></asp:LinkButton>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
