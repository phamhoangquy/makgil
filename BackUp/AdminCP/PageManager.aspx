					...
					<div class="input-group">
							...
							<MasterTableView DataKeyNames="PageID,PageOrder,PageName" AllowPaging="false">
								<Columns>
									...
									<telerik:GridBoundColumn
										HeaderText="<%$Resources:Resource, PageSettingsPageNameLabel %>"
										DataField="PageName" />
									<telerik:GridTemplateColumn HeaderStyle-Width="150">
										<ItemTemplate>
											<asp:HyperLink ID="lnkEditContent" CssClass="cp-link btn bg-blue"
									...
									<telerik:GridTemplateColumn HeaderStyle-Width="50">
										<ItemTemplate>
											<asp:HyperLink CssClass="cp-link btn bg-orange" ID="PagesEditSettings"
												runat="server" Text="<%$Resources:Resource, EditLink %>"
												NavigateUrl='<%# SiteRoot + "/AdminCP/PageSettings.aspx?pageid=" + Eval("PageID") %>'>
											</asp:HyperLink>
										</ItemTemplate>
									</telerik:GridTemplateColumn>
						...
						<div class="">
							<ul class="nav sorter">
								...
								<li>
									<asp:LinkButton ID="btnUp" CommandName="up" runat="server"><i
