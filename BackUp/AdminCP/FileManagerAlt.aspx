...
<asp:Content ContentPlaceHolderID="mainContent" ID="MPContent" runat="server">
	<portal:BreadcrumbAdmin ID="breadcrumb" runat="server"
		CurrentPageTitle="<%$Resources:Resource, AdminMenuFileManagerLink %>"
		CurrentPageUrl="~/AdminCP/FileManagerAlt.aspx" />
	<div class="admin-content admin-content-bg-white">
		<portal:HeadingPanel ID="heading" runat="server">
			<asp:HyperLink SkinID="LinkButton" ID="lnkTreeView" Text="<%$Resources:Resource, TreeViewToggleLink %>"
				runat="server" />
		</portal:HeadingPanel>
