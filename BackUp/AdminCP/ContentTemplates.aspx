...
<asp:Content ContentPlaceHolderID="mainContent" ID="MPContent" runat="server">
	<portal:BreadcrumbAdmin ID="breadcrumb" runat="server" CurrentPageTitle="<%$Resources:Resource, ContentTemplates %>"
			...
			<telerik:RadGrid ID="grid" SkinID="radGridSkin" runat="server">
				<MasterTableView AllowPaging="false" AllowSorting="false">
					<Columns>
						...
						<telerik:GridBoundColumn HeaderText="<%$Resources:Resource, ContentTemplateTitleLabel %>"
							DataField="Title" />
						<telerik:GridBoundColumn HeaderText="<%$Resources:Resource, ContentTemplateTab %>"
							DataField="Body" />
						<telerik:GridBoundColumn HeaderText="<%$Resources:Resource, ContentTemplateDescriptionTab %>"
							DataField="Description" />
						<telerik:GridTemplateColumn HeaderStyle-Width="50">
							<ItemTemplate>
								<asp:HyperLink ID="lnkEdit" runat="server"
									NavigateUrl='<%# SiteRoot + "/AdminCP/ContentTemplateEdit.aspx?t=" + Eval("Guid") %>'
