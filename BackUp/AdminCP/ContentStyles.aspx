...
<asp:Content ContentPlaceHolderID="mainContent" ID="MPContent" runat="server">
	<portal:BreadcrumbAdmin ID="breadcrumb" runat="server"
		CurrentPageTitle="<%$Resources:Resource, ContentStyleTemplates %>"
		CurrentPageUrl="~/AdminCP/ContentStyles.aspx" />
				...
				<MasterTableView DataKeyNames="Guid" EditMode="InPlace" AllowPaging="false" AllowSorting="false">
					<Columns>
						<telerik:GridTemplateColumn>
							...
							<EditItemTemplate>
								<asp:TextBox ID="txtName" runat="server" CssClass="mediumtextbox form-control"
									Text='<%# Eval("Name") %>' MaxLength="100" />
						...
						<telerik:GridTemplateColumn>
							...
							<EditItemTemplate>
								<asp:TextBox ID="txtElement" runat="server" CssClass="smalltextbox form-control"
									Text='<%# Eval("Element") %>' MaxLength="50" />
								<asp:RequiredFieldValidator ID="reqElement" runat="server" Display="Dynamic"
									ControlToValidate="txtElement"
						...
						<telerik:GridTemplateColumn>
							...
							<EditItemTemplate>
								<asp:TextBox ID="txtCssClass" runat="server" CssClass="smalltextbox form-control"
									Text='<%# Eval("CssClass") %>' MaxLength="50" />
								<asp:RequiredFieldValidator ID="reqCssClass" runat="server" Display="Dynamic"
						...
						<telerik:GridTemplateColumn>
							...
							<EditItemTemplate>
								<asp:Button ID="btnGridUpdate" SkinID="UpdateButton" runat="server"
									Text='<%# Resources.Resource.ContentStyleSave %>' CommandName="Update" />
								<asp:Button ID="btnGridDelete" SkinID="DeleteButton" runat="server"
									Text='<%# Resources.Resource.ContentStyleDelete %>' CommandName="Delete" />
								<asp:HyperLink ID="lnkCancel" SkinID="CancelButton" runat="server"
									Text='<%# Resources.Resource.ContentStyleCancel %>'
