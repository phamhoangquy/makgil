						...
						<telerik:GridTemplateColumn>
							...
							<EditItemTemplate>
								<div class="row">
									...
									<div class="col-sm-6">
										<asp:TextBox ID="txtDescription" Columns="20" Text='<%# Eval("Description") %>'
						...
						<telerik:GridTemplateColumn>
							...
							<EditItemTemplate>
								<asp:Button ID="btnGridUpdate" SkinID="UpdateButton" runat="server"
									Text='<%# Resources.Resource.TaxClassGridUpdateButton %>' CommandName="Update" />
								<asp:Button ID="btnGridCancel" SkinID="CancelButton" runat="server"
									Text='<%# Resources.Resource.TaxClassGridCancelButton %>' CommandName="Cancel" />
								<asp:Button ID="btnGridDelete" SkinID="DeleteButton" runat="server"
									Text='<%# Resources.Resource.TaxClassGridDeleteButton %>' CommandName="Delete" />
							</EditItemTemplate>
						</telerik:GridTemplateColumn>
					</Columns>
				</MasterTableView>
