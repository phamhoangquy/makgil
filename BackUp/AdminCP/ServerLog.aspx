...
<asp:Content ContentPlaceHolderID="mainContent" ID="MPContent" runat="server">
	<portal:BreadcrumbAdmin ID="breadcrumb" runat="server"
		CurrentPageTitle="<%$Resources:Resource, AdminMenuServerLogLabel %>"
	...
	<div class="admin-content admin-content-bg-white">
		...
		<div class="workplace mt-20">
						...
						<li class="logitem">
							<h2 class="logitem <%# Eval("LogLevel") %>">
								<asp:LinkButton CommandName="deleteitem" CommandArgument='<%# Eval("ID") %>'
									ToolTip="<%# Resources.Resource.DeleteButton %>" runat="server" ID="btnDeleteItem">
			...
			<asp:Panel ID="pnlFileLog" runat="server">
				<asp:TextBox ID="txtLog" runat="server" Width="100%" Height="300" TextMode="MultiLine"
