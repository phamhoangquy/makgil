...
<asp:Content ContentPlaceHolderID="mainContent" ID="MPContent" runat="server">
    <portal:BreadcrumbAdmin ID="breadcrumb" runat="server"
        CurrentPageTitle="<%$Resources:ProductResources, ProductTagsTitle %>"
        CurrentPageUrl="~/Product/AdminCP/TagList.aspx" />
    <div class="admin-content">
        <portal:NotifyMessage ID="message" runat="server" />
        <portal:HeadingPanel ID="heading" runat="server">
            <asp:HyperLink SkinID="InsertButton" ID="lnkBulkEdit"
                Text="<%$Resources:ProductResources, ProductTagsBulkEdit %>" runat="server" />
            ...
            <telerik:RadGrid ID="grid" SkinID="radGridSkin" runat="server">
                <MasterTableView DataKeyNames="TagId" AllowFilteringByColumn="true" AllowSorting="false">
                    <Columns>
                        ...
                        <telerik:GridBoundColumn HeaderText="<%$Resources:ProductResources, ProductTagName %>"
                            DataField="TagText" CurrentFilterFunction="Contains" AutoPostBackOnFilter="true"
                            ShowFilterIcon="false" FilterControlWidth="100%" />
                        <telerik:GridTemplateColumn HeaderText="<%$Resources:ProductResources, ProductTaggedProducts %>"
