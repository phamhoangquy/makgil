...
<asp:Content ContentPlaceHolderID="mainContent" ID="MPContent" runat="server">
    <portal:BreadcrumbAdmin ID="breadcrumb" runat="server"
        CurrentPageTitle="<%$Resources:ProductResources, CustomFieldsTitle %>"
        CurrentPageUrl="~/Product/AdminCP/CustomFields.aspx" />
            ...
            <telerik:RadGrid ID="grid" SkinID="radGridSkin" runat="server">
                <MasterTableView DataKeyNames="CustomFieldId" AllowPaging="false" AllowSorting="false">
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn
                            HeaderText="<%$Resources:ProductResources, CustomFieldDisplayNameLabel %>">
                            <ItemTemplate>
                                <%# Eval("DisplayName")%>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn
                            HeaderText="<%$Resources:ProductResources, ProductDisplayOrderLabel %>"
                        ...
                        <telerik:GridTemplateColumn>
                            <ItemTemplate>
                                <asp:HyperLink CssClass="cp-link btn bg-orange" ID="EditLink" runat="server"
                                    Text="<%$Resources:ProductResources, CustomFieldEditLink %>"
                                    NavigateUrl='<%# SiteRoot + "/Product/AdminCP/CustomFieldEdit.aspx?id=" + Eval("CustomFieldId") %>'>
								</asp:HyperLink>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
