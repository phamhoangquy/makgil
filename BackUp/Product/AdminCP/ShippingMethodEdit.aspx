...
<asp:Content ContentPlaceHolderID="mainContent" ID="MPContent" runat="server">
    <portal:BreadcrumbAdmin ID="breadcrumb" runat="server"
        ParentTitle="<%$Resources:ProductResources, ShippingMethodsTitle %>"
        ParentUrl="~/Product/AdminCP/ShippingMethods.aspx"
        CurrentPageTitle="<%$Resources:ProductResources, ShippingMethodEditTitle %>"
        CurrentPageUrl="~/Product/AdminCP/ShippingMethodEdit.aspx" />
    <div class="admin-content">
        <asp:UpdatePanel ID="upButton" UpdateMode="Conditional" runat="server">
            <ContentTemplate>
                <portal:NotifyMessage ID="message" runat="server" />
                <portal:HeadingPanel ID="heading" runat="server">
                    <asp:Button SkinID="UpdateButton" ID="btnUpdate" ValidationGroup="ShippingMethodEdit"
                        Text="<%$Resources:Resource, UpdateButton %>" runat="server" />
                    <asp:Button SkinID="UpdateButton" ID="btnUpdateAndNew" ValidationGroup="ShippingMethodEdit"
                        Text="<%$Resources:Resource, UpdateAndNewButton %>" runat="server" />
                    <asp:Button SkinID="UpdateButton" ID="btnUpdateAndClose" ValidationGroup="ShippingMethodEdit"
                        Text="<%$Resources:Resource, UpdateAndCloseButton %>" runat="server" />
                    <asp:Button SkinID="InsertButton" ID="btnInsert" ValidationGroup="ShippingMethodEdit"
                        Text="<%$Resources:Resource, InsertButton %>" runat="server" />
                    <asp:Button SkinID="InsertButton" ID="btnInsertAndNew" ValidationGroup="ShippingMethodEdit"
                        Text="<%$Resources:Resource, InsertAndNewButton %>" runat="server" />
                    <asp:Button SkinID="InsertButton" ID="btnInsertAndClose" ValidationGroup="ShippingMethodEdit"
        ...
        <div class="workplace admin-content-bg-white">
            <div class="form-horizontal">
                <div class="settingrow form-group row align-items-center">
                    <gb:SiteLabel ID="lblShippingProvider" runat="server" ForControl="ddlShippingProvider"
                        CssClass="settinglabel control-label col-sm-3 mb-0" ConfigKey="ShippingMethodProviderLabel"
                    ...
                    <div class="col offset-sm-3">
                        <div class="settingrow form-group">
                            ...
                            <gb:SiteLabel ID="lblIsActive" runat="server" ForControl="chkIsActive"
                                CssClass="settinglabel control-label" ConfigKey="ShippingMethodIsActiveLabel"
                                ResourceFile="ProductResources" />
                            <div class="col-sm-9">
                            </div>
                        </div>
                ...
                <asp:UpdatePanel ID="upFreeShipping" runat="server">
                    <ContentTemplate>
                        <div class="row">
                            <div class="col offset-sm-3">
                                <div id="divFreeShippingOverXEnabled" runat="server" class="settingrow form-group">
                                    ...
                                    <gb:SiteLabel ID="lblFreeShippingOverXEnabled" runat="server"
                                        ForControl="chkFreeShippingOverXEnabled" CssClass="settinglabel control-label"
                                        ConfigKey="ShippingMethodFreeShippingOverXLabel"
                                        ResourceFile="ProductResources" />
                                    <div class="col-sm-9">
                                    </div>
                                </div>
                        ...
                        <div id="divFreeShippingOverXValue" runat="server"
                            class="settingrow form-group row align-items-center">
                            <gb:SiteLabel ID="lblFreeShippingOverXValue" runat="server"
                                ForControl="txtFreeShippingOverXValue"
                                CssClass="settinglabel control-label col-sm-3 mb-0"
                                ConfigKey="ShippingMethodFreeShippingOverXValueLabel" ResourceFile="ProductResources" />
                            <div class="col-sm-9">
                                <asp:TextBox ID="txtFreeShippingOverXValue" runat="server" MaxLength="20"
                    ...
                    <ContentTemplate>
                        ...
                        <div class="settingrow form-group row align-items-center">
                            <gb:SiteLabel ID="lblName" runat="server" ForControl="txtName"
                                CssClass="settinglabel control-label col-sm-3 mb-0" ShowRequired="true"
                            ...
                            <div class="col-sm-9">
                                ...
                                <asp:RequiredFieldValidator ID="reqName" runat="server" ControlToValidate="txtName"
                                    ...
                                    ValidationGroup="ShippingMethodEdit" />
                            </div>
                        </div>
                        <div class="settingrow form-group row align-items-center">
            ...
            <div id="divShippingTableRate" runat="server" class="form-horizontal">
                <div class="settingrow form-group row align-items-center">
                    <gb:SiteLabel ID="lblShippingFee" runat="server" ForControl="txtShippingFee"
                        CssClass="settinglabel control-label col-sm-3 mb-0" />
                ...
                <div id="divImportExport" runat="server">
                    <div class="settingrow form-group row align-items-center">
                        <gb:SiteLabel ID="lblFileUpload" runat="server" ForControl="fileUpload"
                            CssClass="settinglabel control-label col-sm-3 mb-0" ConfigKey="ShippingFeeImportLabel"
                            ResourceFile="ProductResources" />
                        <div class="col-sm-9">
                            <telerik:RadAsyncUpload ID="fileUpload" SkinID="radAsyncUploadSkin"
                                MultipleFileSelection="Disabled" AllowedFileExtensions="xls" runat="server" />
                        </div>
                    </div>
                    <div class="settingrow form-group row align-items-center ">
                        <div class="col-sm-9 offset-sm-3">
                            <asp:Button ID="btnExportTemplate" CssClass="btn btn-default btn-export mr-30"
                                Text="<%$Resources:ProductResources, ShippingFeeExportTemplate %>" runat="server" />
                            <asp:CheckBox ID="chkExportDistrict"
                                Text="<%$Resources:ProductResources, ShippingFeeExportDistrict %>" runat="server" />
                        </div>
                    </div>
                    <div id="divExportData" runat="server" visible="false"
                        class="settingrow form-group row align-items-center">
                        <div class="col-sm-9 col-sm-offset-3">
                            <asp:Button ID="btnExportData" CssClass="btn btn-default btn-export"
                                Text="<%$Resources:ProductResources, ShippingFeeExportData %>" runat="server" />
                        </div>
                    </div>
                        ...
                        <MasterTableView DataKeyNames="ShippingTableRateId">
                            <Columns>
                                <telerik:GridTemplateColumn
                                    HeaderText="<%$Resources:ProductResources, ShippingFeeGeoZoneName %>"
                                    UniqueName="GeoZoneName">
                                    <ItemTemplate>
                                        <%# Eval("GeoZoneName")%>
                                    </ItemTemplate>
                                </telerik:GridTemplateColumn>
                                <telerik:GridTemplateColumn
                                    HeaderText="<%$Resources:ProductResources, ShippingFeeByOrderTotal %>"
                                    UniqueName="FromValue">
                                    <ItemTemplate>
                                ...
                                <telerik:GridTemplateColumn
                                    HeaderText="<%$Resources:ProductResources, ShippingFeeLabel %>">
                                    <ItemTemplate>
                                ...
                                <telerik:GridTemplateColumn Visible="false"
                                    HeaderText="<%$Resources:ProductResources, ShippingMethodFreeShippingOverX %>"
                                    UniqueName="FreeShippingOverXValue">
                                    <ItemTemplate>
