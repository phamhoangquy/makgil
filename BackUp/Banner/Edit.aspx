		...
		<div class="workplace form-horizontal admin-content-bg-white">
			<div class="settingrow form-group row align-items-center">
				<gb:SiteLabel ID="lblZones" runat="server" ConfigKey="ZoneLabel" ResourceFile="Resource"
					ForControl="ddZones" CssClass="settinglabel control-label mb-0 col-sm-3" />
				<div class="col-sm-9">
			...
			<div id="divPosition" visible="false" runat="server" class="settingrow form-group row align-items-center">
				<gb:SiteLabel ID="lblPosition" runat="server" ForControl="chkListPosition"
					CssClass="settinglabel control-label mb-0 col-sm-3" ConfigKey="BannerPositionLabel"
			...
			<div class="settingrow form-group row">
				<div class="col offset-sm-3">
					...
					<gb:SiteLabel ID="lblOpenInNewWindow" runat="server" ForControl="chkOpenInNewWindow"
						CssClass="settinglabel control-label mb-0" ConfigKey="OpenInNewWindowLabel"
						ResourceFile="BannerResources" />
					<div class="">
					</div>
				</div>
			...
			<asp:UpdatePanel ID="up" runat="server">
				<ContentTemplate>
					...
					<div class="settingrow form-group row align-items-center">
						<gb:SiteLabel ID="lblCaption" runat="server" ForControl="txtCaption"
							CssClass="settinglabel control-label mb-0 col-sm-3" ConfigKey="BannerCaptionLabel"
							ResourceFile="BannerResources" />
						<div class="col-sm-9">
							<asp:TextBox ID="txtCaption" runat="server" MaxLength="255" Cssclass="form-control" />
						</div>
					</div>
					<div id="divDescription" runat="server" class="settingrow form-group row align-items-center">
						<gb:SiteLabel ID="lblDescription" runat="server" ForControl="txtDescription"
							CssClass="settinglabel control-label mb-0 col-sm-3" ConfigKey="BannerDescriptionLabel"
							ResourceFile="BannerResources" />
						<div class="col-sm-9">
							<div class="input-group">
								...
								<portal:gbHelpLink ID="GbHelpLink3" runat="server"
									HelpKey="banneredit-description-help" />
							</div>
						</div>
					</div>
					<div class="settingrow form-group row align-items-center">
					...
					<div class="settingrow form-group row align-items-center">
						<gb:SiteLabel ID="lblImageFile" runat="server" ForControl="uplImageFile"
							CssClass="settinglabel control-label mb-0 col-sm-3" ConfigKey="BannerFileLabel"
							ResourceFile="BannerResources" />
						<div class="col-sm-9">
							...
							<telerik:RadAsyncUpload ID="uplImageFile" SkinID="radAsyncUploadSkin"
								MultipleFileSelection="Disabled" AllowedFileExtensions="jpg,jpeg,gif,png"
								runat="server" />
						</div>
					</div>
					<div id="divThumb" runat="server" class="settingrow form-group row align-items-center">
						<gb:SiteLabel ID="lblThumbnail" runat="server" ForControl="uplThumb"
							CssClass="settinglabel control-label mb-0 col-sm-3" ConfigKey="ThumbnailLabel"
							ResourceFile="BannerResources" />
						<div class="col-sm-9">
							<img alt="" id="imgThumb" visible="false" runat="server" src="/Data/SiteImages/1x1.gif" />
							<telerik:RadAsyncUpload ID="uplThumb" SkinID="radAsyncUploadSkin"
								MultipleFileSelection="Disabled" AllowedFileExtensions="jpg,jpeg,gif,png"
								runat="server" />
						</div>
					</div>
			...
			<asp:UpdatePanel ID="upButton" UpdateMode="Conditional" runat="server">
				<ContentTemplate>
					<portal:HeadingPanel ID="heading" runat="server" Cssclass='p-0'>
