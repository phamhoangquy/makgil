...
<asp:Content ContentPlaceHolderID="mainContent" ID="MPContent" runat="server">
	...
	<portal:BreadcrumbAdmin ID="breadcrumb" runat="server"
		CurrentPageTitle="<%$Resources:SharedFileResources, SharedFilesListHeading %>"
		CurrentPageUrl="~/SharedFiles/List.aspx" />
	<div class="admin-content">
		<div class="row">
			<div class="col-12">
				<div class="form-horizontal admin-content-bg-white">
					<portal:HeadingPanel ID="heading" runat="server">
						<asp:Button SkinID="UpdateButton" ID="btnUpdate"
							Text="<%$Resources:SharedFileResources, SharedFilesUpdateButton %>" runat="server" />
						<asp:Button SkinID="DeleteButton" ID="btnDelete"
							Text="<%$Resources:SharedFileResources, SharedFilesDeleteSelectedButton %>" runat="server"
					...
					<asp:Panel ID="pnlUpload" runat="server" DefaultButton="btnUpload">
						<div class="settingrow form-group row">
							<div class="col-sm-9 offset-sm-3">
								<telerik:RadAsyncUpload ID="multiFile" SkinID="radAsyncUploadSkin"
									MultipleFileSelection="Automatic" runat="server" />
							</div>
						</div>
						<div class="settingrow form-group row">
							<div class="col-sm-9 offset-sm-3">
				...
				<div class="workplace">
					<asp:UpdatePanel ID="upFiles" UpdateMode="Conditional" runat="server">
						<ContentTemplate>
							...
							<asp:Panel ID="pnlNewFolder" runat="server" CssClass="form-horizontal"
								DefaultButton="btnNewFolder">
								<div class="settingrow form-group row align-items-center">
									<gb:SiteLabel ID="lblFolderList" runat="server" ForControl="ddFolderList"
										CssClass="settinglabel control-label col-sm-3 mb-0"
									...
									<div class="col-sm-9">
										<div class="form-inline col-sm-12">
											...
											<div class="settingrow form-group">
												<asp:Button SkinID="DefaultButton" ID="btnNewFolder" runat="server"
													Text="<%$Resources:Resource, InsertButton %>"
							...
							<asp:Panel ID="pnlFile" runat="server" DefaultButton="btnUpload"
								Cssclass="admin-content-bg-white">
								<asp:LinkButton ID="btnGoUp" runat="server" OnClick="btnGoUp_Click"><i
										class="fa fa-level-up"></i></asp:LinkButton>
									...
									<MasterTableView DataKeyNames="ID,LanguageID" EditMode="InPlace">
										<Columns>
											<telerik:GridTemplateColumn
												HeaderText="<%$Resources:SharedFileResources, FileManagerFileNameLabel %>">
												<ItemTemplate>
													...
													<asp:Button ID="lnkName" runat="server" CssClass="btn-link"
														Text='<%# DataBinder.Eval(Container.DataItem,"filename") %>'
														CommandName="ItemClicked" CommandArgument='<%# Eval("ID") %>'
														CausesValidation="false"
												...
												<EditItemTemplate>
													<asp:Panel ID="PnlRename" runat="server" DefaultButton="btnRename">
														...
														<asp:Image ID="imgEditType" runat="server"
															ImageUrl="~/Data/SiteImages/Icons/unknown.gif" />
											...
											<telerik:GridTemplateColumn
												HeaderText="<%$Resources:SharedFileResources, FileManagerSizeLabel %>">
												<ItemTemplate>
											...
											<telerik:GridTemplateColumn
												HeaderText="<%$Resources:SharedFileResources, DownloadCountLabel %>">
												<ItemTemplate>
													<asp:Literal ID="litDownloadCount" runat="server"
														Text='<%# DataBinder.Eval(Container.DataItem, "DownloadCount")%>' />
												</ItemTemplate>
											</telerik:GridTemplateColumn>
											<telerik:GridTemplateColumn
												HeaderText="<%$Resources:SharedFileResources, FileManagerModifiedLabel %>">
												<ItemTemplate>
													<asp:Literal ID="litMod" runat="server"
											...
											<telerik:GridTemplateColumn
												HeaderText="<%$Resources:SharedFileResources, SharedFilesUploadedByLabel %>">
												<ItemTemplate>
											...
											<telerik:GridTemplateColumn
												HeaderText="<%$Resources:SharedFileResources, SharedFilesLanguageLabel %>">
												<ItemTemplate>
													<asp:DropDownList ID="ddLanguage" AppendDataBoundItems="true"
														DataTextField="Name" DataValueField="LanguageID" runat="server">
														<asp:ListItem
															Text="<%$Resources:SharedFileResources, SharedFilesLanguageSelector %>"
															Value="-1"></asp:ListItem>
													</asp:DropDownList>
												</ItemTemplate>
											</telerik:GridTemplateColumn>
											<telerik:GridTemplateColumn HeaderStyle-Width="100"
												HeaderText="<%$Resources:SharedFileResources, SharedFilesDisplayOrderLabel %>">
												<ItemTemplate>
													<asp:TextBox ID="txtDisplayOrder" SkinID="NumericTextBox"
														MaxLength="4" Text='<%# Eval("DisplayOrder") %>'
														runat="server" />
												</ItemTemplate>
												<EditItemTemplate>
											...
											<telerik:GridTemplateColumn>
												<ItemTemplate>
													...
													<asp:Literal ID="litDownloadLink1" runat="server"
