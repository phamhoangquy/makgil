				...
				<div class="headInfo form-horizontal admin-content-bg-white">
					<portal:HeadingPanel ID="heading" runat="server">
						<asp:Button SkinID="UpdateButton" ID="btnUpdate"
							Text="<%$Resources:VideoResources, UpdateButton %>" runat="server" />
						<asp:HyperLink SkinID="InsertButton" ID="lnkInsert"
							Text="<%$Resources:VideoResources, InsertLink %>" runat="server" />
						<asp:Button SkinID="DeleteButton" ID="btnDelete"
							Text="<%$Resources:VideoResources, DeleteSelectedButton %>" runat="server"
			...
			<div class="col-12">
				<div class="workplace admin-content-bg-white">
					<telerik:RadGrid ID="grid" SkinID="radGridSkin" runat="server">
						<MasterTableView DataKeyNames="VideoID,DisplayOrder,Position" AllowSorting="false"
							...
							<Columns>
								...
								<telerik:GridTemplateColumn HeaderText="<%$Resources:VideoResources, ThumbnailHeader %>"
								...
								<telerik:GridBoundColumn HeaderText="<%$Resources:VideoResources, FileLocationHeader %>"
									DataField="VideoPath" UniqueName="VideoPath" SortExpression="VideoPath"
									AllowFiltering="false" />
								<telerik:GridTemplateColumn HeaderText="<%$Resources:VideoResources, PositionLabel %>"
									AllowFiltering="false">
									<ItemTemplate>
								...
								<telerik:GridTemplateColumn HeaderStyle-Width="100"
									HeaderText="<%$Resources:VideoResources, DisplayOrderLabel %>"
									AllowFiltering="false">
									<ItemTemplate>
								...
								<telerik:GridTemplateColumn HeaderStyle-Width="100" AllowFiltering="false">
									<ItemTemplate>
										<asp:HyperLink CssClass="cp-link" ID="EditLink" runat="server"
											Text="<%# Resources.VideoResources.VideoEditLabel %>"
