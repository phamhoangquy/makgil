...
<asp:Content ContentPlaceHolderID="mainContent" ID="MPContent" runat="server">
	...
	<portal:BreadcrumbAdmin ID="breadcrumb" runat="server"
		CurrentPageTitle="<%$Resources:GalleryResources, AlbumListLink %>"
		CurrentPageUrl="~/ImageGallery/AlbumList.aspx" />
						...
						<div class="headInfo form-horizontal admin-content-bg-white">
							<portal:HeadingPanel ID="heading" runat="server">
								...
								<asp:Button SkinID="DeleteButton" ID="btnDelete"
									Text="<%$Resources:BannerResources, BannerListDeleteSelectedButton %>"
							...
							<telerik:RadGrid ID="grid" SkinID="radGridSkin" runat="server">
								<MasterTableView DataKeyNames="AlbumId,DisplayOrder,Position">
									<Columns>
										...
										<telerik:GridTemplateColumn
											HeaderText="<%$Resources:GalleryResources, AlbumTitleLabel %>">
											<ItemTemplate>
										...
										<telerik:GridTemplateColumn
											HeaderText="<%$Resources:GalleryResources, AlbumPositionLabel %>"
											UniqueName="Position">
											<ItemTemplate>
												<asp:CheckBoxList ID="chkListPosition" runat="server"
													DataTextField="Name" DataValueField="Value" SkinID="Enum" />
											</ItemTemplate>
										</telerik:GridTemplateColumn>
										<telerik:GridTemplateColumn HeaderStyle-Width="100"
											HeaderText="<%$Resources:GalleryResources, GalleryDisplayOrderLabel %>">
											<ItemTemplate>
										...
										<telerik:GridTemplateColumn HeaderStyle-Width="100" UniqueName="Edit">
											<ItemTemplate>
												<asp:HyperLink ID="EditLink" CssClass="cp-link" runat="server"
													Text="<%# Resources.GalleryResources.GalleryEditLink %>"
