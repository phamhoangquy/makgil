...
<asp:Content ContentPlaceHolderID="mainContent" ID="MPContent" runat="server">
	...
	<portal:BreadcrumbAdmin ID="breadcrumb" runat="server"
		CurrentPageTitle="<%$Resources:GalleryResources, AlbumEditTitle %>"
		CurrentPageUrl="~/ImageGallery/AlbumEdit.aspx" />
	<div class="admin-content">
		<div class="workplace admin-content-bg-white">
			<div class="form-horizontal">
				<div class="settingrow form-group row align-items-center">
					<gb:SiteLabel ID="lblZones" runat="server" ConfigKey="ZoneLabel" ResourceFile="Resource"
						ForControl="ddZones" CssClass="settinglabel control-label col-sm-3 mb-0" />
					<div class="col-sm-9">
				...
				<div id="divPosition" visible="false" runat="server"
					...
					<gb:SiteLabel ID="lblPosition" runat="server" ForControl="chkListPosition"
						CssClass="settinglabel control-label col-sm-3 mb-0" ConfigKey="AlbumPositionLabel"
						ResourceFile="GalleryResources" />
					<div class="col-sm-9">
					...
					<ContentTemplate>
						...
						<div class="settingrow form-group row align-items-center">
							<gb:SiteLabel ID="lblTitle" runat="server" ForControl="txtTitle"
								CssClass="settinglabel control-label col-sm-3 mb-0" ConfigKey="AlbumTitleLabel"
								ResourceFile="GalleryResources" />
							<div class="col-sm-9">
								<asp:TextBox ID="txtTitle" runat="server" MaxLength="255" Cssclass="form-control" />
								<asp:RequiredFieldValidator ID="reqTitle"
									ErrorMessage="<%$Resources:GalleryResources, AlbumTitleRequiredWarning %>"
									runat="server" ControlToValidate="txtTitle" Display="Dynamic" SetFocusOnError="true"
									CssClass="txterror" ValidationGroup="GalleryAlbum" />
							</div>
						</div>
						<div id="divDescription" runat="server" class="settingrow form-group row align-items-center">
							<gb:SiteLabel ID="lblDescription" runat="server" ForControl="txtDescription"
								CssClass="settinglabel control-label col-sm-3 mb-0" ConfigKey="AlbumDescriptionLabel"
								ResourceFile="GalleryResources" />
							<div class="col-sm-9">
								...
								<portal:gbHelpLink ID="GbHelpLink3" runat="server"
									HelpKey="albumedit-description-help" />
							</div>
						</div>
						<div id="divUrl" runat="server" class="settingrow form-group row align-items-center">
							<gb:SiteLabel ID="lblUrl" ForControl="txtUrl"
								CssClass="settinglabel control-label col-sm-3 mb-0" runat="server"
								ConfigKey="AlbumUrlLabel" ResourceFile="GalleryResources" />
							<div class="col-sm-9">
								<asp:TextBox ID="txtUrl" runat="server" MaxLength="255" Cssclass="form-control" />
							</div>
						</div>
					</ContentTemplate>
				</asp:UpdatePanel>
			...
			<div class="form-horizontal">
				<div id="divBulkUpload" runat="server" class="settingrow form-group row align-items-center">
					<gb:SiteLabel runat="server" ForControl="uplImageFile"
						CssClass="settinglabel control-label col-sm-3 mb-0" ConfigKey="spacer"
						ResourceFile="GalleryResources" />
					<div class="col-sm-9">
						<telerik:RadAsyncUpload ID="uplImageFile" SkinID="radAsyncUploadSkin"
							MultipleFileSelection="Automatic" AllowedFileExtensions="jpg,jpeg,gif,png" runat="server" />
					</div>
				</div>
				<asp:Repeater ID="rpt" OnItemDataBound="rpt_ItemDataBound" runat="server">
					<HeaderTemplate>
						<style type="text/css">
							.bulkzone .settingrow form-group row align-items-center {
								padding-left: 100px;
							}

							.bulkzone .settingrow form-group row align-items-center.settinglabel col-md-3 {
								margin-left: -100px;
								width: 90px;
							}
						</style>
			...
			<ItemTemplate>
				<li>
					<div class="bulkzone">
						<div class="settingrow form-group row align-items-center">
							<gb:SiteLabel ID="lblSpacer" runat="server"
								CssClass="settinglabel control-label col-sm-3 mb-0" ConfigKey="spacer" />
							<div class="col-sm-9">
								<img width="260" src='<%#GetWebImageUrl(Eval("WebImageFile").ToString()) %>'
									alt='<%#Eval("Title").ToString()%>' />
							</div>
						</div>
						<div class="settingrow form-group row align-items-center">
							<gb:SiteLabel ID="lblTitle" runat="server" ForControl="txtTitle"
								CssClass="settinglabel control-label col-sm-3 mb-0" ConfigKey="GalleryCaptionLabel"
								ResourceFile="GalleryResources" />
							<div class="col-sm-9">
							...
							<ItemTemplate>
								<div class="settingrow form-group row align-items-center">
									<gb:SiteLabel ID="lblName" runat="server" ForControl="txtName"
										CssClass="settinglabel control-label col-sm-3 mb-0" Text='<%#Eval("Name")%>' />
									<div class="col-sm-9">
										<asp:HiddenField ID="hdnLanguageId" runat="server"
											Value='<%#Eval("LanguageId") %>' />
						...
						<div class="settingrow form-group row align-items-center">
							<gb:SiteLabel ID="lblDisplayOrder" runat="server" ForControl="txtDisplayOrder"
								CssClass="settinglabel control-label col-sm-3 mb-0" ConfigKey="GalleryDisplayOrderLabel"
								ResourceFile="GalleryResources" />
							<div class="col-sm-9">
								...
								<asp:CheckBox ID="chkDelete"
									Text="<%$Resources:GalleryResources, GalleryEditDeleteLabel %>" runat="server" />
							</div>
						</div>
					</div>
				</li>
				...
				<ContentTemplate>
					<portal:HeadingPanel ID="heading" runat="server">
						<asp:Button SkinID="UpdateButton" ID="btnUpdate" Text="<%$Resources:Resource, UpdateButton %>"
							ValidationGroup="GalleryAlbum" runat="server" />
						<asp:Button SkinID="UpdateButton" ID="btnUpdateAndNew"
							Text="<%$Resources:Resource, UpdateAndNewButton %>" ValidationGroup="GalleryAlbum"
							runat="server" />
						<asp:Button SkinID="UpdateButton" ID="btnUpdateAndClose"
							Text="<%$Resources:Resource, UpdateAndCloseButton %>" ValidationGroup="GalleryAlbum"
							runat="server" />
						...
						<asp:Button SkinID="InsertButton" ID="btnInsertAndNew"
							Text="<%$Resources:Resource, InsertAndNewButton %>" ValidationGroup="GalleryAlbum"
							runat="server" />
						<asp:Button SkinID="InsertButton" ID="btnInsertAndClose"
							Text="<%$Resources:Resource, InsertAndCloseButton %>" ValidationGroup="GalleryAlbum"
							runat="server" />
						<asp:Button SkinID="DeleteButton" ID="btnDelete" runat="server"
							Text="<%$Resources:BannerResources, BannerEditDeleteButton %>" CausesValidation="false" />
